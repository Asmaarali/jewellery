...
<head>
   ...
   <link rel="stylesheet" href="css/addproducts.css?v=e031e80c3d8bbbb">
   ...
   <table>
      ...
      <tbody>
         ...
         <tr>
            ...
            <td>
               <a href="addproducts.php?delete=<?php echo $row['pr_id']; ?>" class="delete-btn" onclick="return confirm('are your sure you want to delete this?');"> <i class="fas fa-trash"></i> delete </a>
               <a href="addproducts.php?edit=<?php echo $row['pr_id']; ?>" class="option-btn"> <i class="fas fa-edit"></i> update </a>
            </td>
         </tr>
